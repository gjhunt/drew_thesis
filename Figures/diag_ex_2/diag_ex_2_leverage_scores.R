...
dat=list('1'=generate_mvnorm_single_pop(sample_size=5000,center=rep(0,5),covariance=diag(rep(1,5)))$centered)
for(j in 2:10){
  dat[[paste(j)]]<-generate_mvnorm_single_pop(sample_size=5000,center=rep(0,5),covariance=diag(rep(1,5)))$centered
}
